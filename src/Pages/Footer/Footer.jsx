...
const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-gray-200 font-semibold text-black">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
            <div className="flex items-center justify-center w-3/4 m-auto rounded-full ">
              <img src="https://i.ibb.co/LJpg3n9/task-software.png" className="h-40" alt="" />
            </div>
          </a>
        </div>
      ...
      <div className="py-6 text-sm text-center ">© 2024 <strong>Task. Management,</strong> All rights reserved.</div>
    </footer>
  );
};
