...
const Navbar = () => {
  ...
  // Nav Items
  const NavLinks = (
    <nav className="flex bg-gray-200  gap-3 md:gap-4 lg:gap-10 lg:text-xl text-[18px]">
  ...
  return (
    <nav className="border-gray-200">
      <div className="bg-gray-200 rounded-b-xl flex flex-wrap items-center justify-between mx-auto py-2 px-2">
        <Link to="/" className="flex items-center">
          <img src="https://i.ibb.co/LJpg3n9/task-software.png" className="h-20 mr-3" alt="" />
        </Link>
        <div className="flex items-center md:order-2">
          <div className="relative">
            ...
            <div
              className={`z-50 ${isDashboardMenuOpen ? "block" : "hidden"
            ...
            >
              ...
              <ul className="py-2" aria-labelledby="user-menu-button">
                {user ? (
                  <ul>
                    <li className="block px-4 py-2 text-gray-700 hover:bg-gray-300 text-center">
                      <NavLink to="/">
                        <button>Home</button>
                      </NavLink>
                    </li>
          ...
          >
            ...
            <svg
              className={`w-10 h-10 text-black ${isMobileMenuOpen ? "rotate-180" : ""
                }`}
              aria-hidden="true"
        ...
        {isMobileMenuOpen ? (
          ...
          >
            <ul className="flex flex-col p-4 space-y-4 text-center">
              ...
              <NavLink to="/whyTasky">About Us</NavLink>
