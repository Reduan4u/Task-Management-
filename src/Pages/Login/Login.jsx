...
const Login = () => {
  ...
  const { signInUser, signUpWithGoogle, signUpWithGithub } = useContext(AuthContext);
  ...
  return (
    <div className="flex-row sm:flex-row md:flex-row lg:flex justify-center items-center py-10 gap-5">
      <div className="flex items-center text-center">
        <Lottie className="w-full h-full" animationData={login} loop={true} />
      </div>
      <div className="flex justify-center">
        <div className=" px-8 py-12 bg-[#F7FAFC] rounded-2xl drop-shadow-2xl">
          <div className="relative flex flex-col shadow-none">
            <h4 className="block text-center text-[22px]">Log In</h4>
